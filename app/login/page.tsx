      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            className="w-full rounded-lg bg-zinc-900 px-4 py-2 text-sm bg-linear-to-r from-teal-600 to-teal-700 hover:cursor-pointer hover:ring-inset hover:ring-2 hover:ring-zinc-700 font-medium text-white transition-opacity disabled:opacity-40"
          >
        ...
        <p className="text-center text-sm text-zinc-900">
          No account?{' '}
          <Link href="/signup" className="font-medium text-zinc-700 underline-offset-4 hover:underline hover:cursor-pointer">
            Sign up
          </Link>
        </p>
      </div>
